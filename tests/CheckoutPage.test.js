...
describe('Checkout Page Tests', () => {
    ...
    describe("Invalid Guest Order Checkout Tests", () => {
        ...
        describe("Invalid Guest Checkout Confirmation Tests - Too Long Singular Input", () => {
            ...
            //Test 016aj -> invalid guest check out confirmation test (billing address) - too long guest billing company (100 chars) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Too Long Guest Billing Company", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - too long guest billing company (100 chars)
                await testMethods.invalidOrderCheckoutBillAddressTooLongGuestCompanyTest();
            });
        ...
        describe("Invalid Guest Checkout Confirmation Tests - Invalid Singular Input Format", () => {
            ...
            //Test 016al -> invalid guest check out confirmation test (shipping address) - invalid guest shipping last name format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Shipping Address) Test - Invalid Guest Shipping Last Name Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (shipping address) - invalid guest shipping last name format (special symbols only)
                await testMethods.invalidOrderCheckoutShipAddressInvalidGuestLastNameFormatTest();
            });

            //Test 016am -> invalid guest check out confirmation test (shipping address) - invalid guest shipping address format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Shipping Address) Test - Invalid Guest Shipping Address Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (shipping address) - invalid guest shipping address format (special symbols only)
                await testMethods.invalidOrderCheckoutShipAddressInvalidGuestAddressFormatTest();
            });

            //Test 016an -> invalid guest check out confirmation test (shipping address) - invalid guest shipping post code format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Shipping Address) Test - Invalid Guest Shipping Post Code Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (shipping address) - invalid guest shipping post code format (special symbols only)
            ...
            //Test 016ap -> invalid guest check out confirmation test (shipping address) - invalid guest shipping company format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Shipping Address) Test - Invalid Guest Shipping Company Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (shipping address) - invalid guest shipping company format (special symbols only)
                await testMethods.invalidOrderCheckoutShipAddressInvalidGuestCompanyFormatTest();
            });

            //Test 016aq -> invalid guest check out confirmation test (billing address) - invalid guest billing first name format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing First Name Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing first name format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestFirstNameFormatTest();
            });

            //Test 016ar -> invalid guest check out confirmation test (billing address) - invalid guest billing last name format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing Last Name Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing last name format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestLastNameFormatTest();
            });

            //Test 016as -> invalid guest check out confirmation test (billing address) - invalid guest billing address format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing Address Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing address format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestAddressFormatTest();
            });

            //Test 016at -> invalid guest check out confirmation test (billing address) - invalid guest billing post code format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing Post Code Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing post code format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestPostCodeFormatTest();
            });

            //Test 016au -> invalid guest check out confirmation test (billing address) - invalid guest billing city format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing City Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing city format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestCityFormatTest();
            });

            //Test 016av -> invalid guest check out confirmation test (billing address) - invalid guest billing company format (special symbols only) (the order gets submitted, test has failed)
            test("Invalid Guest Checkout Confirmation (Billing Address) Test - Invalid Guest Billing Company Format", async function () {
                //home page product ('The Grand Grotsby') addition to cart test (as a guest)
                await testMethods.addHomePageGrandGrotsbyBookToCart();
                //home page product ('The Grand Grotsby') addition to check out test (as a guest)
                await testMethods.addProductToCheckoutTest();
                //invalid guest check out confirmation test (billing address) - invalid guest billing company format (special symbols only)
                await testMethods.invalidOrderCheckoutBillAddressInvalidGuestCompanyFormatTest();
            });
