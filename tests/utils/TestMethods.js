...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async invalidOrderCheckoutBillAddressInvalidGuestFirstNameFormatTest(){
        ...
        //capture screenshot of the shipping address form before invalid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display Before Guest Data Input");
        //input invalid guest first name format into billing address first name input field (special symbols only)
    ...
    //invalid order checkout test method (billing address) - invalid guest billing last name input format (special symbols only)
    async invalidOrderCheckoutBillAddressInvalidGuestLastNameFormatTest(){
        const generalPage = new GeneralPage(this.driver);
        const checkoutPage = new CheckoutPage(this.driver)
        const checkoutPageInvalidScenarios = new CheckoutPageInvalidScenarios(this.driver);
        //general page web element assert
        ...
        await checkoutPageInvalidScenarios.inputInvalidGuestLastNameFormatIntoBillAddressLastNameInputField();
        //input valid guest address into billing address input field
        await checkoutPage.inputGuestAddressIntoBillAddressInputField();
        //input valid guest post code into billing address post code input field
        await checkoutPage.inputGuestPostCodeIntoBillAddressPostCodeInputField();
        ...
        await checkoutPage.inputGuestCompanyIntoBillAddressCompanyInputField();
        //capture screenshot of the shipping address form after valid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display After Invalid Guest Data Input - Invalid Billing Last Name Input Format");
        //click 'Buy' button
        await checkoutPage.clickBuyButton();
        //if the order gets submitted successfully, log the issue
        if(await checkoutPage.getCheckoutRecapSuccessMessage()){
            Logger.error("The invalid billing address last name input format error hasn't been triggered, test has failed.");
        }
        //capture screenshot of the test result
        await TestMethods.captureScreenshot(this.driver, "Invalid Guest Order Checkout (Billing Address) Test Result - Invalid Billing Last Name Format");
    }
    //invalid order checkout test method (billing address) - invalid guest billing address input format (special symbols only)
    async invalidOrderCheckoutBillAddressInvalidGuestAddressFormatTest(){
        const generalPage = new GeneralPage(this.driver);
        const checkoutPage = new CheckoutPage(this.driver)
        const checkoutPageInvalidScenarios = new CheckoutPageInvalidScenarios(this.driver);
        //general page web element assert
        ...
        //input valid guest last name into billing address last name input field
        await checkoutPage.inputGuestLastNameIntoBillAddressLastNameInputField();
        //input invalid guest address format into billing address input field (special symbols only)
        await checkoutPageInvalidScenarios.inputInvalidGuestAddressFormatIntoBillAddressInputField();
        //input valid guest post code into billing address post code input field
        await checkoutPage.inputGuestPostCodeIntoBillAddressPostCodeInputField();
        //input valid guest city into billing address city input field
        await checkoutPage.inputGuestCityIntoBillAddressCityInputField();
        ...
        await checkoutPage.inputGuestCompanyIntoBillAddressCompanyInputField();
        //capture screenshot of the shipping address form after valid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display After Invalid Guest Data Input - Invalid Billing Address Input Format");
        //click 'Buy' button
        await checkoutPage.clickBuyButton();
        //if the order gets submitted successfully, log the issue
        if(await checkoutPage.getCheckoutRecapSuccessMessage()){
            Logger.error("The invalid billing address input format error hasn't been triggered, test has failed.");
        }
        //capture screenshot of the test result
        await TestMethods.captureScreenshot(this.driver, "Invalid Guest Order Checkout (Billing Address) Test Result - Invalid Billing Address Format");
    }
    //invalid order checkout test method (billing address) - invalid guest billing post code input format (special symbols only)
    async invalidOrderCheckoutBillAddressInvalidGuestPostCodeFormatTest(){
        const generalPage = new GeneralPage(this.driver);
        const checkoutPage = new CheckoutPage(this.driver)
        const checkoutPageInvalidScenarios = new CheckoutPageInvalidScenarios(this.driver);
        //general page web element assert
        ...
        //input valid guest address into billing address input field
        await checkoutPage.inputGuestAddressIntoBillAddressInputField();
        //input invalid guest post code format into billing address post code input field (special symbols only)
        await checkoutPageInvalidScenarios.inputInvalidGuestPostCodeFormatIntoBillAddressPostCodeInputField();
        //input valid guest city into billing address city input field
        await checkoutPage.inputGuestCityIntoBillAddressCityInputField();
        //input valid guest company into billing address company input field
        await checkoutPage.inputGuestCompanyIntoBillAddressCompanyInputField();
        //capture screenshot of the shipping address form after valid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display After Invalid Guest Data Input - Invalid Billing Post Code Input Format");
        //click 'Buy' button
        await checkoutPage.clickBuyButton();
        //if the order gets submitted successfully, log the issue
        if(await checkoutPage.getCheckoutRecapSuccessMessage()){
            Logger.error("The invalid billing post code input format error hasn't been triggered, test has failed.");
        }
        //capture screenshot of the test result
        await TestMethods.captureScreenshot(this.driver, "Invalid Guest Order Checkout (Billing Address) Test Result - Invalid Billing Post Code Format");
    }
    //invalid order checkout test method (billing address) - invalid guest billing city input format (special symbols only)
    async invalidOrderCheckoutBillAddressInvalidGuestCityFormatTest(){
        const generalPage = new GeneralPage(this.driver);
        const checkoutPage = new CheckoutPage(this.driver)
        const checkoutPageInvalidScenarios = new CheckoutPageInvalidScenarios(this.driver);
        //general page web element assert
        ...
        await checkoutPageInvalidScenarios.inputInvalidGuestCityFormatIntoBillAddressCityInputField();
        //input valid guest company into billing address company input field
        await checkoutPage.inputGuestCompanyIntoBillAddressCompanyInputField();
        //capture screenshot of the shipping address form after valid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display After Invalid Guest Data Input - Invalid Billing City Input Format");
        //click 'Buy' button
        await checkoutPage.clickBuyButton();
        //if the order gets submitted successfully, log the issue
        if(await checkoutPage.getCheckoutRecapSuccessMessage()){
            Logger.error("The invalid billing city input format error hasn't been triggered, test has failed.");
        }
        //capture screenshot of the test result
        await TestMethods.captureScreenshot(this.driver, "Invalid Guest Order Checkout (Billing Address) Test Result - Invalid Billing City Format");
    }
    //invalid order checkout test method (billing address) - invalid guest billing company input format (special symbols only)
    async invalidOrderCheckoutBillAddressInvalidGuestCompanyFormatTest(){
        const generalPage = new GeneralPage(this.driver);
        const checkoutPage = new CheckoutPage(this.driver)
        const checkoutPageInvalidScenarios = new CheckoutPageInvalidScenarios(this.driver);
        //general page web element assert
        ...
        //input valid guest city into billing address city input field
        await checkoutPage.inputGuestCityIntoBillAddressCityInputField();
        //input invalid guest company format into billing address company input field (special symbols only)
        await checkoutPageInvalidScenarios.inputInvalidGuestCompanyFormatIntoBillAddressCompanyInputField();
        //capture screenshot of the shipping address form after valid guest input data (billing address)
        await TestMethods.captureScreenshot(this.driver, "Checkout Page Billing Address Section Display After Invalid Guest Data Input - Invalid Billing Company Input Format");
        //click 'Buy' button
        await checkoutPage.clickBuyButton();
        //if the order gets submitted successfully, log the issue
        if(await checkoutPage.getCheckoutRecapSuccessMessage()){
            Logger.error("The invalid billing company input format error hasn't been triggered, test has failed.");
        }
        //capture screenshot of the test result
        await TestMethods.captureScreenshot(this.driver, "Invalid Guest Order Checkout (Billing Address) Test Result - Invalid Billing Company Format");
    }
