...
class CheckoutPageInvalidScenarios extends BasePage{
    ...
    async inputInvalidGuestPostCodeFormatIntoShipAddressPostCodeInputField() {
        const shipAddressPostCodeInputField = await this.driver.findElement(this._checkoutPageShipAddressPostCodeInputField);
        const invalidGuestShipAddressPostCodeFormat = this._guestCheckoutInvalidPostCodeFormat;
        Logger.info("Invalid guest checkout post code format (shipping address): ", invalidGuestShipAddressPostCodeFormat);
        await shipAddressPostCodeInputField.sendKeys(invalidGuestShipAddressPostCodeFormat);
    }
    ...
    async inputInvalidGuestCityFormatIntoBillAddressCityInputField() {
        const billAddressCityInputField = await this.driver.findElement(this._checkoutPageBillingAddressCityInputField);
        const invalidBillAddressGuestCityFormat = this._guestCheckoutInvalidCityFormat;
        Logger.info("Invalid guest checkout city format (billing address): ", invalidBillAddressGuestCityFormat);
        await billAddressCityInputField.sendKeys(invalidBillAddressGuestCityFormat);
    }
    async inputInvalidGuestCompanyFormatIntoBillAddressCompanyInputField() {
        const billAddressCompanyInputField = await this.driver.findElement(this._checkoutPageBillingAddressCompanyInputField);
        const invalidBillAddressCompanyFormat = this._guestCheckoutInvalidCompanyFormat;
        Logger.info("Invalid guest checkout company format (billing address): ", invalidBillAddressCompanyFormat);
        await billAddressCompanyInputField.sendKeys(invalidBillAddressCompanyFormat);
    }
